        ...
        <div v-else class="project-grid">
          <div v-for="(project, index) in filteredProjects" :key="project.id"
            ...
            <div class="flex-1 flex flex-col min-w-0">
              ...
              <p class="text-[0.68rem] font-semibold text-slate-400 px-5 mt-0.5">{{ Number(project.unit_id) === 1 ? 'Facilities & Grounds Maintenance Unit (FGMU)' : 'Landscaping & Environmental Affairs Unit (LEAU)' }}</p>
