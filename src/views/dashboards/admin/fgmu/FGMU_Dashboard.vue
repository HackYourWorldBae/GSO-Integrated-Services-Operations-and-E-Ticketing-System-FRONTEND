    ...
    <template #header-title>
      <div class="flex items-center gap-3 sm:gap-4">
        ...
        <router-link
          ...
          title="Submit a service request for FGMU or other campus units"
        >
              ...
              >
                <div>
                  <div class="flex items-center justify-between gap-1 mb-1">
                    <span 
                      ...
                      :class="selectedPeriod === 'day' && selectedDate === day.date ? 'text-emerald-400' : (day.is_today ? 'text-emerald-600' : 'text-slate-500')"
                    >
                      {{ day.day_name }}
                    </span>
                    <span 
                      ...
                      :class="selectedPeriod === 'day' && selectedDate === day.date ? 'bg-emerald-400/20 text-emerald-300' : 'bg-emerald-100 text-emerald-700'"
                    >
                      Today
                    </span>
                  </div>
                ...
                <div class="mt-3 pt-2.5 border-t" :class="selectedPeriod === 'day' && selectedDate === day.date ? 'border-slate-800' : 'border-slate-200/70'">
                  ...
                  <div class="flex items-center justify-between text-[11px]">
                    <span :class="selectedPeriod === 'day' && selectedDate === day.date ? 'text-emerald-300' : 'text-emerald-600'">Completed</span>
                    <span class="font-black tabular-nums" :class="selectedPeriod === 'day' && selectedDate === day.date ? 'text-emerald-400' : 'text-emerald-700'">{{ day.completed_jobs }}</span>
                  </div>
