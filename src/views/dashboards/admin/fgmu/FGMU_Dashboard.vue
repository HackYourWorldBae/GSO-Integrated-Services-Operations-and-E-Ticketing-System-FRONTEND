  ...
  <MainLayout>
    ...
    <template #header-title>
      <div class="flex flex-col">
        <h2 class="text-xl sm:text-2xl font-black text-slate-900 tracking-tight leading-tight">FGMU Dashboard</h2>
        <p class="text-xs text-emerald-600 font-extrabold tracking-wider uppercase">Facilities & Ground Management</p>
      </div>
    </template>
      ...
      <div class="space-y-8 animate-fade-in pb-12">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="group p-5 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white border border-slate-200/80 shadow-md hover:shadow-xl transition-all flex flex-col justify-between">
              ...
              <div>
                ...
                <p class="text-xs sm:text-sm text-slate-600 font-bold uppercase tracking-wider mt-1">Total Requests</p>
              </div>
            </div>
            ...
            <div class="group p-5 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white border border-slate-200/80 shadow-md hover:shadow-xl transition-all flex flex-col justify-between">
              ...
              <div>
                ...
                <p class="text-xs sm:text-sm text-slate-600 font-bold uppercase tracking-wider mt-1">Resolved Tickets</p>
              </div>
            </div>
        ...
        <div class="space-y-4">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-1">
            <div>
              <h3 class="text-sm sm:text-base font-black uppercase tracking-wider text-slate-800 flex items-center gap-2">
                <span class="w-2.5 h-5 rounded-full bg-emerald-600 shrink-0"></span>
            ...
            <span class="self-start sm:self-auto text-xs font-black text-emerald-700 bg-emerald-50 border border-emerald-200 px-3 py-1.5 rounded-full uppercase tracking-wider flex items-center gap-1.5 shrink-0">
