      ...
      <div class="space-y-8 animate-fade-in pb-12">
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <!-- 1. Total Requests -->
            <div class="group p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-2xl transition-all flex flex-col justify-between">
              <div class="flex items-center justify-between gap-2 mb-4">
                <div class="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-slate-900 text-white shrink-0">
            ...
            <!-- 2. Resolved Tickets -->
            <div class="group p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white border border-slate-100 shadow-xl hover:shadow-2xl transition-all flex flex-col justify-between">
              <div class="flex items-center justify-between gap-2 mb-4">
                <div class="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-emerald-50 text-emerald-600 shrink-0">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between px-1">
            ...
            <span class="text-[10px] font-black text-emerald-700 bg-emerald-50 border border-emerald-200/60 px-2.5 py-1 rounded-full uppercase tracking-wider flex items-center gap-1.5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="group p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white border border-slate-100 shadow-xl hover:shadow-2xl transition-all flex flex-col justify-between">
              <div class="flex items-center justify-between gap-2 mb-4">
                <div class="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-amber-50 text-amber-600 shrink-0">
            ...
            >
              <div class="flex items-center justify-between gap-2 mb-4">
                <div class="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-blue-50 text-blue-600 group-hover:scale-110 transition-transform shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                </div>
              ...
              <div>
                <h3 class="text-2xl sm:text-3xl font-black text-slate-900 tabular-nums">{{ stats.scheduled || 0 }}</h3>
            ...
            >
              <div class="flex items-center justify-between gap-2 mb-4">
                <div class="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-emerald-100 text-emerald-700 group-hover:scale-110 transition-transform shrink-0">
              ...
              <div>
                <h3 class="text-2xl sm:text-3xl font-black text-slate-900 tabular-nums">{{ stats.active_working || 0 }}</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <!-- Performance Radar -->
          <div class="p-5 sm:p-8 rounded-2xl sm:rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col min-h-[320px] lg:h-[400px]">
          ...
          <div class="p-5 sm:p-8 rounded-2xl sm:rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col justify-between">
            <div>
          ...
          <div class="p-5 sm:p-8 rounded-2xl sm:rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col lg:col-span-2 space-y-6">
