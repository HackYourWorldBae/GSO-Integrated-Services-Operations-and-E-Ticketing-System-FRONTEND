          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="relative flex-1 max-w-md">
              <input
                v-model="searchQuery"
                type="text"
                placeholder="Search staff by name, specialty, or phone..."
        ...
        <div class="bg-white rounded-3xl sm:rounded-[2rem] w-full max-w-md p-6 sm:p-8 shadow-2xl border border-slate-100 animate-scale-up">
          ...
          <form @submit.prevent="submitAddPersonnel" class="space-y-4">
            <div>
              ...
              <input v-model="addForm.firstName" required placeholder="e.g. Juan" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500" />
            </div>
            <div class="grid grid-cols-2 gap-3">
              <div>
                <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Middle Initial</label>
                <input v-model="addForm.middleInitial" maxlength="2" placeholder="e.g. D." class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500" />
              </div>
              <div>
                <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Name Extension</label>
                <input v-model="addForm.nameExtension" placeholder="e.g. Jr., III" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500" />
              </div>
            </div>
            <div>
              <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Last Name *</label>
              <input v-model="addForm.lastName" required placeholder="e.g. Dela Cruz" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500" />
            </div>
            <div>
