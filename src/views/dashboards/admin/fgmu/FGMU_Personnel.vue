                    ...
                    <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 xl:max-w-3xl items-stretch">
                      ...
                      >
                        <div>
                          ...
                          <p class="text-sm font-bold leading-snug text-slate-800">{{ worker.ticketTask || (worker.isProject ? 'Office Project Work' : 'Facilities Maintenance Work') }}</p>
                        </div>
                      ...
                      >
                        <div>
                          ...
                          <p class="text-sm font-bold text-slate-800">{{ worker.nextTicketTask || (worker.nextIsProject ? 'Office Project Work' : 'Facilities Maintenance Work') }}</p>
                        </div>
