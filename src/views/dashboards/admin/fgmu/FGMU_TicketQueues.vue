  ...
  <MainLayout>
    ...
    <template #main-content>
      <div class="space-y-6 animate-fade-in relative pb-12">
        ...
        <div class="p-4 rounded-2xl bg-gradient-to-r from-slate-50 via-emerald-50/50 to-slate-50 border border-slate-200/90 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs shadow-2xs">
        ...
        <div class="md:hidden space-y-3">
          ...
          <div
            v-for="ticket in paginatedTickets"
            :key="ticket.id"
            class="bg-white rounded-2xl border border-slate-200 hover:border-emerald-400 hover:bg-emerald-50/20 hover:shadow-md transition-all cursor-pointer p-4 space-y-3 group active:scale-[0.99]"
            @click="openDetailsModal(ticket)"
          >
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <span class="font-mono text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  #{{ ticket.ticketId }}
                </span>
                <span class="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-200/60 flex items-center gap-1">
