<template>
  <MainLayout>
    <template #sidebar-links>
      ...
      <router-link to="/admin/ssu/investigating-tickets" class="nav-item" exact-active-class="router-link-active" active-class="router-link-active">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <template #main-content>
      <SSU_IncidentWorkspace active-queue="investigating" />
    </template>
  </MainLayout>
</template>
