  ...
  <MainLayout>
    <template #header-title>
      <div class="flex flex-col">
        ...
        <p class="text-xs text-emerald-600 font-black tracking-wider uppercase">Landscaping Ticket Dispatch &amp; Work Scheduling</p>
      </div>
    </template>
    ...
    <template #main-content>
      <TicketDispatchWorkspace
        unit-code="LEAU"
        unit-title="Landscape &amp; Environment Aesthetics Unit"
        :store="leauStore"
      />
    </template>
  </MainLayout>
