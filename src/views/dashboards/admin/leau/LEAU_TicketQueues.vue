  ...
  <MainLayout>
    ...
    <template #header-title>
      <div class="flex flex-col">
        ...
        <p class="text-[10px] text-amber-600 font-extrabold tracking-[0.2em] uppercase mt-1">LEAU Unit Head Monitoring & Approval</p>
      </div>
    </template>
      ...
      <div class="space-y-6 animate-fade-in relative pb-12">
              ...
              <tbody class="divide-y divide-slate-100">
                ...
                >
                  ...
                  <td v-if="activeTab === 'active'" class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div class="text-[9px] font-bold text-amber-700">Standard Work Hours Only</div>
                  </td>
        ...
        <div class="md:hidden space-y-3">
          <div v-if="isLoading && currentTabTickets.length === 0" class="text-center py-12 bg-white rounded-3xl border border-slate-200 p-6">
            <svg class="animate-spin h-6 w-6 text-amber-600 mx-auto mb-2" fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
          ...
          >
            ...
            <div v-if="activeTab === 'active'" class="text-[11px] text-slate-600 bg-amber-50/50 p-2.5 rounded-xl border border-amber-100 space-y-1">
              <div class="flex items-center justify-between">
                <span>Worker:</span>
            ...
            <div class="pt-2 border-t border-slate-100 flex items-center justify-end gap-2" @click.stop>
              ...
              <button
                v-if="activeTab === 'pending'"
                @click="initiateApproval(ticket)"
                class="px-4 py-1.5 rounded-xl bg-amber-600 text-white text-xs font-black uppercase tracking-wider"
              >
                Approve
              </button>
              <button
    ...
    <div class="bg-white rounded-3xl p-6 sm:p-8 max-w-2xl w-full shadow-2xl border border-slate-200 animate-scale-up space-y-6 max-h-[90vh] overflow-y-auto custom-scrollbar">
      ...
      <div class="pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
        ...
        <div v-if="activeTab === 'pending'" class="flex items-center gap-2">
          ...
          <button @click="initiateApproval(selectedTicketForModal); selectedTicketForModal = null" class="px-5 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-black uppercase tracking-wider">
            Approve Request
          </button>
        </div>
