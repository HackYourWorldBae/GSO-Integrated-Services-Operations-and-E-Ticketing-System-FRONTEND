  ...
  <MainLayout>
    ...
    <template #header-title>
      <div class="flex flex-col">
        ...
        <p class="text-[10px] text-slate-500 font-extrabold tracking-[0.2em] uppercase">FGMU Dispatcher Projects</p>
      </div>
    </template>
            ...
            <div class="flex-1 flex flex-col min-w-0">
              ...
              <div class="flex items-start gap-2.5 flex-wrap px-5 py-3">
                <div class="flex flex-col gap-0.5 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 flex-1 min-w-[120px]">
                  ...
                  <span class="text-sm font-black text-slate-900">{{ formatDate(project.project_actual_start || project.assignment?.dispatched_at || project.assignment?.assigned_at || project.assignment?.implementation_date || project.project_target_date) }}</span>
                </div>
                <div class="flex flex-col gap-0.5 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 flex-1 min-w-[120px]">
...
export default {
  name: 'FGMU_DispatcherProjectArchives',
