  ...
  <MainLayout>
    ...
    <template #header-title>
      <div class="flex flex-col">
        <h2 class="text-xl font-bold text-slate-900 tracking-tight leading-none mb-1">FGMU Analytics</h2>
        <p class="text-[10px] text-emerald-600 font-extrabold tracking-[0.2em] uppercase">Facilities & Ground Management Oversight</p>
      </div>
    </template>
          ...
          <div v-else-if="activeProjects.length === 0" class="flex flex-col sm:flex-row items-center justify-between gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-200/70">
            <div class="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">No active scheduled campus facilities projects currently posted.</p>
              </div>
            </div>
          </div>
