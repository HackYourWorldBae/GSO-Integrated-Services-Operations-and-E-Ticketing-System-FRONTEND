        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between px-1">
            ...
            <div class="flex items-center gap-3">
              <span class="hidden sm:inline-flex text-[10px] font-black text-blue-700 bg-blue-50 border border-blue-200/60 px-2.5 py-1 rounded-full uppercase tracking-wider items-center gap-1.5">
                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"></span>
                Live Operations
              </span>
              <router-link
                to="/admin/fgmu/queues"
                class="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all shadow-sm hover:shadow"
              >
                <span>Open FGMU Queues</span>
