          ...
          <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 p-2">
            ...
            <div class="relative flex-1">
              ...
              <input
                ...
                class="w-full pl-8 pr-8 py-2.5 sm:py-2 min-h-[44px] sm:min-h-0 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 text-base sm:text-xs font-semibold placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 focus:bg-white transition-all"
              />
              <button
                v-if="searchQuery"
            ...
            <select
              ...
              class="px-2.5 py-2.5 sm:py-2 min-h-[44px] sm:min-h-0 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 text-base sm:text-xs font-semibold focus:outline-none focus:border-amber-500 transition-all shrink-0 touch-manipulation cursor-pointer"
            >
        ...
        <div class="p-5 sm:p-6 overflow-y-auto space-y-4 sm:space-y-5 custom-scrollbar text-xs flex-1">
          ...
          <div v-if="getAssignedWorkers(selectedTicketForModal).length > 0" class="p-4 sm:p-5 rounded-2xl bg-slate-900 text-white space-y-3">
            <div class="flex items-center justify-between gap-3 flex-wrap">
              <div class="flex items-center gap-2">
                <span class="text-[10px] font-black uppercase tracking-widest text-amber-400">Assigned Personnel</span>
                <span class="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 text-[10px] font-black">
      ...
      <div class="bg-white rounded-3xl max-w-lg w-full shadow-2xl border border-slate-200 animate-scale-up flex flex-col max-h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-4rem)] overflow-hidden">
        ...
        <div class="p-5 sm:p-6 overflow-y-auto space-y-4 custom-scrollbar flex-1">
          ...
          <div class="p-3 sm:p-3.5 rounded-xl bg-amber-50/70 border border-amber-200/80 text-xs sm:text-sm text-amber-900 flex items-start gap-2.5 leading-relaxed">
            ...
            <span>This ticket will be excluded from the pending approval queue until directly approved once ready.</span>
          </div>
        </div>
