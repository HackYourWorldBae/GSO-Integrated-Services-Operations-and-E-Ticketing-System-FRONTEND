<template>
  <div class="space-y-6">
    <!-- Executive Overview -->
    <div class="space-y-1">
      <router-link to="/director/dashboard" exact-active-class="router-link-active" active-class="" class="nav-item">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
        </svg>
        <span class="text">Executive Overview</span>
      </router-link>
      <router-link to="/director/materials" exact-active-class="router-link-active" active-class="" class="nav-item group">
        ...
        <span class="text">Material Logs and Report</span>
      </router-link>
    </div>
    ...
    <div>
      ...
      <nav class="space-y-1">
        ...
        <router-link to="/director/fgmu/queues" exact-active-class="router-link-active" active-class="" class="nav-item group">
          ...
          <span class="text truncate">FGMU Queues</span>
        </router-link>

        <!-- LEAU Ticket Queues: Leaf / Ecology -->
        <router-link to="/director/leau/queues" exact-active-class="router-link-active" active-class="" class="nav-item group">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-emerald-500 group-hover:text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <span class="text truncate">LEAU Queues</span>
        </router-link>
      </nav>
    </div>
    ...
    <div>
      ...
      <nav class="space-y-1">
        ...
        <router-link to="/director/fgmu" exact-active-class="router-link-active" active-class="" class="nav-item group">
          ...
          <span class="text truncate">FGMU Facilities</span>
        </router-link>

        <!-- LEAU Environment: Leaf / Ecology -->
        <router-link to="/director/leau" exact-active-class="router-link-active" active-class="" class="nav-item group">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-emerald-500 group-hover:text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12" />
          </svg>
          <span class="text truncate">LEAU Environment</span>
        </router-link>

        <!-- SSU Security: Shield / Campus Safety -->
        <router-link to="/director/ssu" exact-active-class="router-link-active" active-class="" class="nav-item group">
          ...
          <span class="text truncate">SSU Security</span>
        </router-link>
      </nav>
    </div>
