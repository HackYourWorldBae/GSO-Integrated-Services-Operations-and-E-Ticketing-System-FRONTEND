        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col min-h-[350px] lg:h-[400px]">
            ...
            <div class="flex-1 relative">
              <canvas id="directorLeauCompletionDoughnut"></canvas>
            </div>
          </div>
...
const renderCharts = () => {
  ...
  const completionCtx = document.getElementById('directorLeauCompletionDoughnut');
  ...
  // 2. Delay Reasons
  const delayCtx = document.getElementById('directorLeauDelayReasonsChart');
  ...
  // 3. Non-Completion
  const nonCompCtx = document.getElementById('directorLeauNonCompletionChart');
