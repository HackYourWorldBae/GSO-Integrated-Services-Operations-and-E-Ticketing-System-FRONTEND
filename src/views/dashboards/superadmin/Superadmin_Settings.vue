          ...
          <div class="p-4 sm:p-8 md:p-12 space-y-6 sm:space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
              ...
              <div class="space-y-2 md:col-span-2">
                ...
                <p class="text-[11px] text-slate-400 font-medium ml-1">Primary administrative system email address. Used for login and system notifications.</p>
              </div>
            ...
            <div class="p-4 sm:p-5 rounded-2xl border flex items-start gap-3.5 transition-colors" :class="form.emailNotificationsEnabled ? 'bg-emerald-50/60 border-emerald-200/70' : 'bg-slate-50 border-slate-200'">
              ...
              <div class="flex-1 min-w-0 space-y-1">
                ...
                <p class="text-xs leading-relaxed font-medium" :class="form.emailNotificationsEnabled ? 'text-emerald-800/80' : 'text-slate-500'">
                  When on, superadmin-level system updates notify <span class="font-bold">this address ({{ form.email || 'your email' }})</span>. Toggle off to stay dashboard-only.
                </p>
                <p v-if="!form.emailNotificationsEnabled" class="text-[11px] font-bold text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-2.5 py-1.5">Email alerts are paused.</p>
              </div>
            </div>
