      ...
      <div class="space-y-6">
        ...
        <div class="space-y-4 pt-2">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            <!-- 1. What to repair -->
            <div class="p-3.5 rounded-2xl bg-emerald-50/70 border border-emerald-200/70 flex items-start gap-3 shadow-2xs">
              ...
              <div>
                ...
                <div class="text-[11px] text-slate-600 font-medium mt-0.5 leading-snug">
                  Photos showing the defective item, electrical fixture, water leak, or facility to repair.
                </div>
              </div>
            </div>
            ...
            <div class="p-3.5 rounded-2xl bg-amber-50/70 border border-amber-200/70 flex items-start gap-3 shadow-2xs">
              ...
              <div>
                ...
                <div class="text-[11px] text-slate-600 font-medium mt-0.5 leading-snug">
                  Close-up evidence showing structural cracks, water stains, wear-and-tear, or hazards.
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div class="w-12 h-12 mx-auto mb-3 rounded-2xl bg-white border border-slate-200 group-hover:border-emerald-300 group-hover:bg-emerald-100/50 flex items-center justify-center text-slate-400 group-hover:text-emerald-700 transition-all shadow-xs">
          ...
          <div v-if="formsStore.fgmuState.attachments.length > 0" class="space-y-2 animate-fade-in pt-1">
            <div class="flex items-center justify-between text-xs font-bold text-slate-500 px-1">
              ...
              <button type="button" @click="formsStore.fgmuState.attachments = []" class="text-red-500 hover:text-red-700 hover:underline cursor-pointer">
                Remove All
              </button>
            </div>
