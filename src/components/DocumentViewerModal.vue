<template>
  <Teleport to="body">
    <Transition name="doc-modal">
      ...
      >
        <div class="my-auto bg-white w-full max-w-5xl max-h-[calc(100dvh-2rem)] sm:max-h-[88vh] h-[92vh] rounded-[2rem] shadow-2xl flex flex-col overflow-hidden border border-slate-200 relative animate-scale-up pointer-events-auto">
