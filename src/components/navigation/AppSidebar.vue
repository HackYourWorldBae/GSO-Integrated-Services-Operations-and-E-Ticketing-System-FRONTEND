    ...
    return [
      {
        ...
        items: [
          ...
          {
            label: 'Material Logs and Report',
    ...
    <div v-for="(group, gIdx) in navGroups" :key="gIdx">
      ...
      <nav class="space-y-1.5">
        ...
        >
          ...
          <!-- Request Service Plus Icon -->
          <svg v-else-if="item.icon === 'request'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
